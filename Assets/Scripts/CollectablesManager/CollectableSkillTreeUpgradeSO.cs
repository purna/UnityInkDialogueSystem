...
public class CollectableSkillTreeUpgradeSO : CollectableSOBase
{
    ...
    public override void Collect(GameObject objectThatCollected)
    {
        ...
        if (skillPointsToGrant > 0 && SkillTreeManager.Instance != null)
        {
        ...
        if (autoUnlockSkill)
        {
            ...
            {
                targetSkill = SkillTreeManager.Instance?.SkillTreeContainer?.GetSkillByName(skillNameToUnlock);
            }
            
            if (targetSkill != null && SkillTreeManager.Instance != null)
            {
                ...
                if (targetSkill.CanUnlock())
                {
                    ...
                    if (SkillTreeManager.Instance.TryUnlockSkill(targetSkill))
                    {
