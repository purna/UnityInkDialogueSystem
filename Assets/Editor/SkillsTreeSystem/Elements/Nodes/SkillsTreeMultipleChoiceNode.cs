...
public class SkillsTreeMultipleChoiceNode : SkillsTreeBaseNode {
    protected override SkillsTreeType _type => SkillsTreeType.MultipleChoice;

    public override void Initialize(string nodeName, SkillsTreeSystemGraphView graphView, Vector2 position) {
        base.Initialize(nodeName, graphView, position);
        SkillsTreeChoiceSaveData choice = new("New Tier");
        _choices.Add(choice);
    }
    ...
    protected override Port CreateChoicePort(object userData) {
        ...
        SkillsTreeChoiceSaveData choiceData = (SkillsTreeChoiceSaveData)userData;
